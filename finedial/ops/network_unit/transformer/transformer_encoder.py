...
Folked from OpenNMT, onmt.encoders.tenasfomer_encoder
"""
import torch
import torch.nn as nn
from finedial.ops.network_unit.transformer.multi_head_attention import MultiHeadedAttention
from finedial.ops.network_unit.transformer.position_ffn import PositionwiseFeedForward
...
def _select_time_first_sequence_embedding(inputs, index):
        """
...
class TransformerEncoder:
    ...
    def forward(self, src, lengths=None):
        ...
        last_output = _select_time_first_sequence_embedding(memory_bank, lengths-1)
        return emb, memory_bank, lengths, last_output
